...
resource functionAppUrlNamedValue 'Microsoft.ApiManagement/service/namedValues@2023-05-01-preview' = {
  parent: apimService
...
resource oauthApi 'Microsoft.ApiManagement/service/apis@2021-08-01' = {
  ...
  properties: {
    ...
    serviceUrl: 'https://login.microsoftonline.com/${tenantId}/oauth2/v2.0'
  }
}
...
// Add a GET operation for the OAuth callback endpoint
resource exchangeOperation 'Microsoft.ApiManagement/service/apis/operations@2021-08-01' = {
  parent: oauthApi
  name: 'exchange'
  properties: {
    displayName: 'Exchange'
    method: 'GET'
    urlTemplate: '/exchange'
    description: 'OAuth 2.0 exchance endpoint to handle authorization code flow'
  }
}

// Add policy for the OAuth callback operation
resource exchangePolicy 'Microsoft.ApiManagement/service/apis/operations/policies@2021-08-01' = {
  parent: exchangeOperation
  name: 'policy'
  properties: {
    format: 'rawxml'
...
//output oauthClientId string = entraApp.outputs.appId
//output oauthIdentifier string = entraApp.outputs.identifierUri
